                    ...
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr id="quick_tr_header">
                            ...
                            <th scope="col" class="px-2 py-1  lg:px-6 lg:py-4  md:px-4  md:py-2"
                                ...
                                Company&ensp; <i class="fa-solid fa-sort"></i>
                            </th>
                            <th scope="col" class="px-2 py-1  lg:px-6 lg:py-4  md:px-4  md:py-2"
                                onclick="dynamic_sort('content','string','quick')">
                                Department&ensp; <i class="fa-solid fa-sort"></i>
                            </th>
                                                ...
                                                <form>
                                                    ...
                                                    <div class="p-2">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class=" text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
