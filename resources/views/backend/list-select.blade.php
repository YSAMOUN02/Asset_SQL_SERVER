...
<div class="container-height   shadow-md sm:rounded-lg dark:bg-gray-800">
    ...
    <div class="search-bar bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        {{-- <form action="/admin/assets/add/search" method="POST">
                @csrf --}}
        <div class="max-w-full min-h-full grid px-2 py-1 gap-2 grid-cols-3 lg:grid-cols-6">
            <div>
            ...
            <div>
                ...
                <label for="department_name"
                    class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Department Name</label>
                ...
                <label for="employee_name"
                    class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Employee Name</label>
