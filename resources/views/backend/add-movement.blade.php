...
@section('content')
    ...
    <form class="p-2 lg:p-10 py-2 lg:py-15 bg-white dark:bg-gray-900" enctype="multipart/form-data" action="/admin/movement/add/detail/submit" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
            ...
            <div class="grid gap-6 lg:grid-cols-1 md:grid-cols-1">
                ...
                <div>
                    <label for="given_by" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Given
                        ...
                        @else
                        <input  id="to_department"  readonly    name="to_department" type="text" class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="grid gap-6 lg:grid-cols-1 md:grid-cols-1">
                <span class="title_base text-lg text-black dark:text-blue-100">Movement To</span>
                <div>
                    <label for="from_department"
                ...
                <div class="py-1 lg:py-5  border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid  gap-1 lg:gap-6 mb-1 lg:mb-6 grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="Reference" readonly
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="assets_no" value="{{ old('document', $asset->assets1 . $asset->assets2 ?? '') }}" />
